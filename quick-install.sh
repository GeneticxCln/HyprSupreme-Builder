#!/bin/bash
# HyprSupreme-Builder v4.0.0 Enhanced Edition - Quick Install Script
...
print_banner() {
    ...
    echo "║                                                               ║"
    echo "║          Enhanced Edition v4.0.0 - Quick Install             ║"
    echo "║                                                               ║"
...
print_features() {
    echo -e "${CYAN}${BOLD}${STAR} What's New in v4.0.0 Enhanced Edition:${NC}"
    echo
...
install_hyprsupreme() {
    ...
    echo -e "${BLUE}${INFO} Downloading HyprSupreme-Builder v4.0.0 Enhanced Edition...${NC}"
    if ! git clone --depth 1 --branch release/v4.0.0 https://github.com/GeneticxCln/HyprSupreme-Builder.git "$install_dir"; then
...
main() {
    ...
    echo -e "${YELLOW}${BOLD}${ROCKET} Ready to install HyprSupreme-Builder v4.0.0 Enhanced Edition${NC}"
    echo
